...
#SBATCH --mem=256G
#SBATCH --job-name=lg_fsq_sair
#SBATCH -t 7-00:00:00
#SBATCH -q premium
#SBATCH --exclude=b200-st-b200-11,b200-st-b200-14,b200-st-b200-2-47,b200-st-b200-2-49,b200-st-b200-2-79,b200-st-b200-2-77,b200-st-b200-2-17,b200-st-b200-2-14
...
# FSQ with SAIR dataset - FSQ levels: [8, 5, 5, 5] = 1000 tokens for both protein and ligand
srun -u --cpus-per-task $SLURM_CPUS_PER_TASK --cpu-bind=cores,verbose \
    lobster_train \
    experiment=train_latent_generator \
    data=structure_ligand_pdb_sair \
    ...
    model.optim.lr=1e-4 \
    'model.quantizer.protein_levels=[8,5,5,5]' \
    'model.quantizer.ligand_levels=[8,5,5,5]' \
    model.decoder_factory.decoder_mapping.vit_decoder.struc_token_codebook_size=1000 \
    model.decoder_factory.decoder_mapping.vit_decoder.ligand_struc_token_codebook_size=1000 \
    'model.structure_encoder.embed_dim=4' \
