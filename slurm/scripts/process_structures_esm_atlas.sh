#!/bin/bash
#SBATCH --job-name=process_esm_atlas
#SBATCH --partition=himem
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=1
#SBATCH --cpus-per-task=128
#SBATCH --mem=1000G  # himem nodes have 1TB memory
#SBATCH --time=48:00:00
#SBATCH --output=/homefs/home/lisanzas/scratch/Develop/lobster/slurm/logs/process_esm_atlas_%j.out
#SBATCH --error=/homefs/home/lisanzas/scratch/Develop/lobster/slurm/logs/process_esm_atlas_%j.err
