...
#SBATCH -o /cv/scratch/u/lisanzas/slurm_logs/train_gen_ume_protein_ligand_no_geom/%J_%x.out
#SBATCH -e /cv/scratch/u/lisanzas/slurm_logs/train_gen_ume_protein_ligand_no_geom/%J_%x.err
#SBATCH --mem=256G
#SBATCH --job-name=gen_ume_pl_no_geom
#SBATCH -t 7-00:00:00
#SBATCH -q llm

# Gen-UME Protein-Ligand Training Script - SMALL MODEL, NO GEOM
# 
# This trains the SMALL unified model (~150M params) on:
...
#
# Usage:
#   sbatch slurm/scripts/train_gen_ume_protein_ligand_no_geom.sh
...
# Directory setup
export LOBSTER_RUNS_DIR="/cv/scratch/u/lisanzas/gen_ume_protein_ligand_no_geom/runs/"
...
mkdir -p /cv/scratch/u/lisanzas/slurm_logs/train_gen_ume_protein_ligand_no_geom
...
# Small model (~150M params) without GEOM data
uv run lobster_train \
    ...
    logger.name=gen_ume_protein_ligand-small_no_geom_joint_encoding \
