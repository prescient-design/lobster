...
#SBATCH --mem=128G
#SBATCH -o /cv/scratch/u/lisanzas/proteina_gen_logs/%A_%a.out
#SBATCH -e /cv/scratch/u/lisanzas/proteina_gen_logs/%A_%a.err
#SBATCH --job-name=proteina-gen
#SBATCH -t 02:00:00
#SBATCH --array=0-499
...
echo "[RUN] $TASK_NAME (array task $SLURM_ARRAY_TASK_ID, line $LINE_NUM)"
...
if complexa design "configs/${CONFIG_NAME}.yaml" \
    ...
    "++autoencoder_ckpt_path=${PROTEINA_DIR}/ckpts/complexa_ligand_ae.ckpt"; then
    echo "[DONE] $TASK_NAME"
else
