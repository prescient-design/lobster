...
# Gen-UME Protein-Ligand Training Script - RESUME
# 
# This resumes training from the latest checkpoint.
#
# Usage:
#   sbatch slurm/scripts/train_gen_ume_protein_ligand_resume.sh
...
CHECKPOINT="/cv/scratch/u/lisanzas/gen_ume_protein_ligand/runs//2026-01-28T01-08-34/epoch=5-step=1645-val_loss=5.7382.ckpt"
...
uv run lobster_train \
    ...
    logger.name=gen_ume_protein_ligand-small_pdb_geom_pbind_sair_bond_se3_minimize \
