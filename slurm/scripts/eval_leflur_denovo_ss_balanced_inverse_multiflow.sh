...
#SBATCH -o /cv/scratch/u/lisanzas/slurm_logs/eval_gen_ume_denovo_last/%J_ss_balanced_inv_mf.out
#SBATCH -e /cv/scratch/u/lisanzas/slurm_logs/eval_gen_ume_denovo_last/%J_ss_balanced_inv_mf.err
#SBATCH --mem=128G
#SBATCH --job-name=ss_bal_inv_mf
#SBATCH -t 1-00:00:00
#SBATCH -q llm
...
OUT_DIR="/cv/scratch/u/lisanzas/evaluations/${EVAL_PREFIX}_ckpt_${EVAL_TIMESTAMP}_multiflow_inverse_folding"
