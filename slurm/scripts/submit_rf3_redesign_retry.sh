...
#SBATCH --mem=64G
#SBATCH -o /cv/scratch/u/lisanzas/evaluations/plinder_redesign_2026-03-23T13-10-31/rf3_retry_logs/rf3retry_%A_%a.out
#SBATCH -e /cv/scratch/u/lisanzas/evaluations/plinder_redesign_2026-03-23T13-10-31/rf3_retry_logs/rf3retry_%A_%a.err
#SBATCH --job-name=rf3-retry
#SBATCH -t 08:00:00
#SBATCH --array=0-890
