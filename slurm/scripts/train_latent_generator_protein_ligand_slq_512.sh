...
# SLQ with 512 tokens for both protein and ligand
srun -u --cpus-per-task $SLURM_CPUS_PER_TASK --cpu-bind=cores,verbose \
    ...
    model.decoder_factory.decoder_mapping.vit_decoder.struc_token_codebook_size=512 \
