...
#SBATCH --mem=256G
#SBATCH --job-name=genume-all-bs28
#SBATCH -t 7-00:00:00
#SBATCH -o /cv/scratch/u/lisanzas/slurm_logs/train_gen_ume_all/resume_%j.out
#SBATCH -e /cv/scratch/u/lisanzas/slurm_logs/train_gen_ume_all/resume_%j.err

# Resume gen_ume_all training from step 19442 / 50000
...
uv run lobster_train \
    ...
    logger.name=gen_ume_all-medium_bs28_lr1e-3_resume_0415 \
