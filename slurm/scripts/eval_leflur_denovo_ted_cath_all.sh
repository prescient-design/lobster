#!/usr/bin/env bash
# Submit all 3 eval jobs for gen_ume_denovo_ted_cath BASELINE (5-dataset, no SS balancing)
# Run dir: 2026-03-14T13-50-37 (Job 6061624)
# Usage: bash slurm/scripts/eval_gen_ume_denovo_ted_cath_all.sh

CKPT_SOURCE="/cv/scratch/u/lisanzas/gen_ume_denovo_ted_cath/runs/2026-03-14T13-50-37/last.ckpt"
RUN_TS="2026-03-14T13-50-37"
SNAPSHOT_DIR="/cv/scratch/u/lisanzas/evaluations/checkpoint_snapshots"
EVAL_PREFIX="gen_ume_denovo_ted_cath"
...
if [ -f "${CKPT_SOURCE}" ]; then
    echo "Copying baseline checkpoint to snapshot: ${SNAPSHOT_CKPT}"
