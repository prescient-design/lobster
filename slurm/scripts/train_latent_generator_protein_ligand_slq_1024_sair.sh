...
# SLQ with 1024 tokens for both protein and ligand
srun -u --cpus-per-task $SLURM_CPUS_PER_TASK --cpu-bind=cores,verbose \
    ...
    model.optim.lr=5e-4 \
    model.quantizer.n_tokens=1024 \
    model.quantizer.ligand_n_tokens=1024 \
    model.decoder_factory.decoder_mapping.vit_decoder.struc_token_codebook_size=1024 \
    model.decoder_factory.decoder_mapping.vit_decoder.ligand_struc_token_codebook_size=1024 \
