...
#SBATCH --mem=256G
#SBATCH --job-name=lg_fsq_lig1000
#SBATCH -t 7-00:00:00
#SBATCH -q premium
#SBATCH --exclude=b200-st-b200-11,b200-st-b200-14,b200-st-b200-2-47,b200-st-b200-2-49,b200-st-b200-2-79,b200-st-b200-2-77,b200-st-b200-2-17
...
# FSQ levels: [8, 5, 5, 5] = 1000 tokens for both protein and ligand (4 dimensions)
