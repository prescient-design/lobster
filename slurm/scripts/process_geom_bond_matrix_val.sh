...
#SBATCH --time=4:00:00
#SBATCH --array=0-9
#SBATCH --output=/data2/lisanzas/slurm_logs/geom_val_%A_%a.out
#SBATCH --error=/data2/lisanzas/slurm_logs/geom_val_%A_%a.err

# =============================================================================
# GEOM Val Processing - Add bond_matrix from S3 SDF files
# =============================================================================
# 10 jobs x ~3.1K files each = ~31K files total
# Input: /data/bucket/lisanza/structures/GEOM/processed/val/
# Output: /data2/lisanzas/geom_12_15_25/val/
# =============================================================================
...
# Configuration
INPUT_DIR="/data/bucket/lisanza/structures/GEOM/processed/val"
OUTPUT_DIR="/data2/lisanzas/geom_12_15_25/val"
TOTAL_FILES=30953
NUM_JOBS=10
