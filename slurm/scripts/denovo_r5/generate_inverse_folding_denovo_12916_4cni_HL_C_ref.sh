...
#SBATCH -o /data2/ume/gen_ume/slurm/logs/generate/%J_%x.out
#SBATCH -q preempt
#SBATCH --mem=64G
#SBATCH --job-name=gen_inverse_folding_denovo_12916_4cni_HL_C_ref
#SBATCH -t 7-00:00:00
...
# Run generation with the inverse folding de novo config
uv run python -m lobster.cmdline.generate \
    --config-path "../hydra_config/experiment" \
    --config-name experiment/denovo_r5/generate_inverse_folding_denovo_12916_4cni_HL_C_ref
