...
#SBATCH --mem=256G
#SBATCH --job-name=gen_ume_pl_med
#SBATCH -t 7-00:00:00
#SBATCH -q llm

# Gen-UME Protein-Ligand Training Script - MEDIUM MODEL (~480M params)
# 
...
#
# Usage:
#   sbatch slurm/scripts/train_gen_ume_protein_ligand_medium.sh
...
# Medium model: ~480M params (hidden_size=768, num_layers=66)
# Reduced batch_size to 4 and increased accumulate_grad_batches to 80 for memory
uv run lobster_train \
    ...
    logger.name=gen_ume_protein_ligand-medium_pdb_geom_pbind_sair_bond
