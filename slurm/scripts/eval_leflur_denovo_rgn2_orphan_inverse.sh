...
#SBATCH --mem=128G
#SBATCH --job-name=eval_rgn2_orphan_inv
#SBATCH -t 1-00:00:00
#SBATCH -q llm

# Gen-UME Inverse Folding Evaluation on RGN2 orphan dataset
...
uv run python -m lobster.cmdline.generate \
    ...
    --config-name experiment/research/generate_inverse_folding_denovo_rgn2_orphan
