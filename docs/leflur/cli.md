...
| `binder_design` (3Di, a8) | `experiment/generate_binder_3di` | `leflur-binder-3di` |
| `binder_design` (3Di, best) | `experiment/generate_binder_3di_best` | `leflur-binder-3di` |
...
**Binder design** (`experiment/generate_binder_3di` / `_binder_3di_best` / `_binder_disto`):
