...
from ._pplm_fold_base import PPLMFoldBase
from ._pplm_fold_configuration import PPLMFOLD_CONFIG_ARGS, PPLMFoldConfig
...
class PrescientPLMFold(pl.LightningModule):
    def __init__(
        ...
        tokenizer_dir: a tokenizer saved to src/prescient_plm/assets
