    ...
    "LG 20A seq 3di c6d Aux dec960 PDB": ModelInfo(
        ...
        model_config=ModelConfig(
            ...
            overrides=[
                ...
                "+tokenizer.decoder_factory.decoder_mapping.vit_decoder.attention_dropout=0.1",
                "+tokenizer.decoder_factory.decoder_mapping.vit_decoder.dropout=0.1",
                "tokenizer.decoder_factory.decoder_mapping.vit_decoder.struc_token_dim=960",
                "+tokenizer.structure_encoder.dropout=0.1",
                "+tokenizer.structure_encoder.attention_dropout=0.1",
                "tokenizer.structure_encoder.embed_dim=256", 
                "tokenizer.quantizer.embed_dim=256",
    ...
    "LG 20A seq 3di c6d 512 Aux": ModelInfo(
        ...
        model_config=ModelConfig(
            ...
            overrides=[
                ...
                "+tokenizer.structure_encoder.attention_dropout=0.1", 
                "tokenizer.structure_encoder.embed_dim=512", 
                "tokenizer.quantizer.embed_dim=512", 
                "tokenizer.structure_encoder.embed_dim_hidden=512", 
                "tokenizer/decoder_factory=struc_decoder_3di_c6d_sequence", 
                "tokenizer/loss_factory=structure_losses_3di_c6d_sequence", 
                "+tokenizer.decoder_factory.decoder_mapping.vit_decoder.dropout=0.1", 
                "+tokenizer.decoder_factory.decoder_mapping.vit_decoder.attention_dropout=0.1", 
                "tokenizer.decoder_factory.decoder_mapping.c6d_decoder.struc_token_codebook_size=512", 
...
LG ESMC 300M 960 full cont
    Description: Sequence-only model with ESMC 300m embeddings
    Features:
    - 960-dim embeddings (both encoder and decoder)
    - ESMC 300m embeddings
    - no quantization
