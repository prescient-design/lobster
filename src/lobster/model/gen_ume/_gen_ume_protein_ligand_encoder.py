"""Gen-UME Protein-Ligand Encoder Module.

This module extends the Gen-UME encoder to support both protein-only and
...
- Ligand-optional forward pass (behaves like original Gen-UME when no ligand)
"""
...
class ProteinLigandEncoderModule(nn.Module):
    ...
    original Gen-UME for backward compatibility.
    ...
    **neobert_kwargs
    ...
    Examples
    --------
    >>> encoder = ProteinLigandEncoderModule(hidden_size=256, num_hidden_layers=6)
