...
class SimplifiedPEEREvaluationCallback(LinearProbeCallback):
    """Simplified PEER evaluation callback that uses embed_sequences from the model.

    This version removes all tokenization complexity and always calls the model's
    embed_sequences method with raw sequences, regardless of model type.
