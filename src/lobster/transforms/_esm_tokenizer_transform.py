...
class ESMTokenizerTransform(Transform):
    """Transform for ESM (Evolutionary Scale Modeling) tokenization.

    Uses HuggingFace's AutoTokenizer to load the correct ESM tokenizer.

    Parameters
    ----------
    pretrained_model_name_or_path : str | PathLike
        Name or path of pretrained ESM model (e.g., 'facebook/esm2_t33_650M_UR50D')
