...
# Further modifications made from Xinyou Wang's version
#
# Original file was released under MIT license.
...
def create_parser():
    ...
    parser.add_argument(
        ...
        type=Path,
        required=True,
        default="ROOTDIR/" + "generation-results/" + "touchhigh_various_length_all",
    )
    parser.add_argument(
        "-o",
        "--pdb",
